...
export function BYOKSection() {
    return (
        <section className="py-24 bg-subtle border-t border-border-subtle">
            <div className="container mx-auto px-4 relative z-20">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="max-w-5xl mx-auto rounded-3xl overflow-hidden bg-card shadow-xl border border-border-subtle relative"
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-0 relative z-10 text-text-primary">
                        {/* Left Col: Simple Visual */}
                        <div className="p-10 md:p-12 border-b md:border-b-0 md:border-r border-border-subtle flex flex-col bg-subtle/50">
                            <div className="flex items-center gap-2 mb-6 mt-0">
                                <img src="https://openrouter.ai/favicon.ico" alt="OpenRouter" className="w-8 h-8" />
                                <span className="text-lg font-bold text-text-secondary">OpenRouter</span>
                            </div>
                            <div className="space-y-4">
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-4 p-4 bg-card rounded-xl border border-border-subtle shadow-sm hover:border-emerald-300 hover:shadow-md transition-all cursor-pointer group"
                                >
                                    <div className="w-8 h-8 rounded-lg bg-emerald-100 text-emerald-600 flex items-center justify-center font-bold">1</div>
                                    <div className="flex-1">
                                        <div className="text-xs font-bold text-text-muted uppercase">GET KEY</div>
                                        <div className="text-sm font-medium flex items-center gap-1.5 text-text-primary">
                                    ...
                                    <ArrowRight className="text-text-muted group-hover:text-emerald-500 group-hover:translate-x-1 transition-all" />
                                </a>

                                {/* Step 2 */}
                                <div className="flex items-center gap-4 p-4 bg-card rounded-xl border border-border-subtle shadow-sm relative overflow-hidden">
                                    <div className="w-8 h-8 rounded-lg bg-blue-100 text-blue-600 flex items-center justify-center font-bold">2</div>
                                    <div className="flex-1">
                                        <div className="text-xs font-bold text-text-muted uppercase">PASTE</div>
                                        <div className="flex items-center gap-2 mt-1">
                                            <div className="h-2 w-2 rounded-full bg-green-500"></div>
                                            <code className="bg-subtle px-2 py-0.5 rounded text-xs text-text-secondary font-mono">sk-or-v1...</code>
                                        </div>
                                    </div>
                                </div>

                                {/* Step 3 */}
                                <div className="flex items-center gap-4 p-4 bg-card rounded-xl border border-border-subtle shadow-sm opacity-60">
                                    <div className="w-8 h-8 rounded-lg bg-orange-100 text-orange-600 flex items-center justify-center font-bold">3</div>
                                    <div className="flex-1">
                                        <div className="text-xs font-bold text-text-muted uppercase">PAY AS YOU GO</div>
                                        <div className="text-sm font-medium text-text-primary">Zero markup. Pennies per site.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-10 md:p-12 flex flex-col justify-center bg-card">
                            ...
                            <h2 className="text-xl md:text-2xl font-bold mb-4 tracking-tight text-text-primary">Just bring your own key.</h2>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <span className="text-sm font-medium text-text-secondary">Keys are stored locally in your browser</span>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="w-6 h-6 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                                    ...
                                    <div className="flex-1">
                                        <span className="text-sm font-medium text-text-secondary block mb-3">Access GPT-5.2 Chat, Claude Sonnet 4.5, Gemini 3 Flash, Grok 4.1 Fast, and more</span>
                                        <div className="flex items-center justify-center gap-4 pt-2 border-t border-border-subtle">
                                            <OpenAILogo className="w-7 h-7 text-text-secondary opacity-80 hover:opacity-100 transition-opacity" />
                                            <AnthropicLogo className="w-7 h-7 text-text-secondary opacity-80 hover:opacity-100 transition-opacity" />
                                            <GoogleLogo className="w-7 h-7 opacity-80 hover:opacity-100 transition-opacity" />
                                            <XAILogo className="w-7 h-7 text-text-secondary opacity-80 hover:opacity-100 transition-opacity" />
                                        </div>
                                    </div>
                                </div>
                            </div>
