...
export function SplitScreenDemo() {
    return (
        <section className="relative py-20 overflow-hidden">
            {/* Background gradient */}
            <div className="absolute inset-0 bg-gradient-to-b from-white via-neutral-50 to-neutral-100 -z-10"></div>
            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <div className="relative rounded-xl overflow-hidden shadow-2xl border border-neutral-300 bg-white ring-1 ring-black/5">
                        {/* Browser Chrome */}
                        <div className="flex items-center gap-2 px-4 py-3 bg-[#f3f3f3] border-b border-neutral-300">
                            ...
                            <div className="flex-1 mx-4">
                                <div className="bg-white rounded-[4px] px-3 py-1.5 text-xs text-neutral-600 border border-neutral-200 flex items-center justify-center shadow-inner max-w-xl mx-auto">
                                    <span className="opacity-70">https://</span>
                                    <span className="font-medium text-neutral-800">stripe.com</span>
                                </div>
                            </div>
                            {/* Browser Actions */}
                            <div className="flex items-center gap-3 pr-2">
                                ...
                                <PuzzlePiece size={18} className="text-neutral-600" />
                                <DotsThreeVertical size={20} className="text-neutral-500" />
                            </div>
                        </div>

                        {/* Split View Container */}
                        <div className="flex h-[640px] relative bg-white">
                                ...
                                <div className="bg-white w-full h-full rounded-l-xl border border-neutral-200 shadow-lg flex flex-col overflow-hidden">
                                    ...
                                    <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-200 bg-white h-[57px]">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="font-mono font-bold text-sm text-neutral-900 tracking-wider">HWTB</span>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4 px-4 py-3 border-b border-neutral-100 bg-white">
                                        <div className="text-neutral-500"><CaretRight size={16} className="rotate-180" /></div>
                                        <div className="h-5 w-[1px] bg-neutral-200"></div>
                                        <div className="flex items-center gap-2">
                                            <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                                            <span className="font-mono text-[11px] font-bold text-neutral-900 uppercase tracking-widest">SITE / STRIPE.COM</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-shrink-0 p-4 border-t border-neutral-100 bg-white">
                                        <button className="w-full h-[44px] bg-[#151515] text-white rounded-[4px] font-mono text-[11px] font-bold tracking-[0.15em] hover:bg-neutral-800 transition-colors flex items-center justify-center gap-2 uppercase shadow-md">
